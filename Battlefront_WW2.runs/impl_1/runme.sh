...
HD_PWD='C:/Users/Paulo/Documents/GitHub/Battlefront_WW2/Battlefront_WW2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log battlefront_ww2_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source battlefront_ww2_top.tcl -notrace
