...
HD_PWD='C:/Users/Paulo/Documents/GitHub/Battlefront_WW2/Battlefront_WW2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log battlefront_ww2_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source battlefront_ww2_top.tcl
